...
public class MainActivity__ extends AppCompatActivity implements BaiduMap.OnMarkerClickListener, BaiduMap.OnMapClickListener, BaiduMap.OnMapStatusChangeListener {
    ...
    private void initNavigatin() {
        ...
        BaiduNaviManager.getInstance().init(this, mSDCardPath, APP_FOLDER_NAME, new BaiduNaviManager.NaviInitListener() {
            ...
            public void onAuthResult(int status, String msg) {
                ...
                MainActivity__.this.runOnUiThread(new Runnable() {

                    @Override
                    public void run() {
                        Toast.makeText(MainActivity__.this, authinfo, Toast.LENGTH_LONG).show();
                    }
                });
            }
            ...
            public void initStart() {
                Toast.makeText(MainActivity__.this, "百度导航初始化开始", Toast.LENGTH_SHORT).show();
            }

            @Override
            public void initSuccess() {
                Toast.makeText(MainActivity__.this, "百度导航初始化成功", Toast.LENGTH_SHORT).show();
                hasInitSuccess = true;
                initSetting();
            }
            ...
            public void initFailed() {
                Toast.makeText(MainActivity__.this, "百度导航引擎初始化失败", Toast.LENGTH_SHORT).show();
            }
    ...
    public void showToastMsg(final String msg) {
        MainActivity__.this.runOnUiThread(new Runnable() {
            ...
            @Override
            public void run() {
                Toast.makeText(MainActivity__.this, msg, Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    private void routeplanToNavi(LatLng currentLatLng, boolean isSimulation) {
        ...
        if (!hasInitSuccess) {
            Toast.makeText(MainActivity__.this, "还未初始化!", Toast.LENGTH_SHORT).show();
        }
        // 权限申请
        if (Build.VERSION.SDK_INT >= 23) {
            // 保证导航功能完备
            if (!hasCompletePhoneAuth()) {
                if (!hasRequestComAuth) {
                    ...
                    Toast.makeText(MainActivity__.this, "没有完备的权限!", Toast.LENGTH_SHORT).show();
                }
            }
...
//        eNode = new BNRoutePlanNode(113.9410840000, 22.5460020000, "终点站", null, mCoordinateType);
    ...
    public class DemoRoutePlanListener implements BaiduNaviManager.RoutePlanListener {
        ...
        public void onJumpToNavigator() {
            ...
            Intent intent = new Intent(MainActivity__.this, BNGuideActivity.class);
            Bundle bundle = new Bundle();
        ...
        public void onRoutePlanFailed() {
            ...
            Toast.makeText(MainActivity__.this, "算路失败", Toast.LENGTH_SHORT).show();
        }
    }
...
//            mBaiduMap.setMyLocationEnabled(true);//当不需要定位图层时关闭定位图层
            ...
            if (isFirstIn) {
                ...
                Toast.makeText(MainActivity__.this, bdLocation.getAddrStr(), Toast.LENGTH_SHORT).show();
            }
        ...
        if (requestCode == authBaseRequestCode) {
            for (int ret : grantResults) {
                if (ret == 0) {
                    ...
                    Toast.makeText(MainActivity__.this, "缺少导航基本的权限!", Toast.LENGTH_SHORT).show();
                    return;
                }
            }
            initNavigatin();
